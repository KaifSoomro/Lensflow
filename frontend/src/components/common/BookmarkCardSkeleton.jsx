...
const BookmarkCardSkeleton = () => {
  return (
    <div className="relative mt-30 mb-7 w-full overflow-hidden border border-neutral-300 break-inside-avoid animate-pulse">
      <div className="w-full h-70 bg-neutral-200" />
