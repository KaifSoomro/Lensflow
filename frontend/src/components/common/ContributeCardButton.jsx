...
import PhotoOne from "../../assets/images/contribute_card_image_1.jpg";
import PhotoTwo from "../../assets/images/contribute_card_image_2.jpg";
import IllustrationOne from "../../assets/images/illustration.jpg";
import IllustrationTwo from "../../assets/images/illustration2.jpg";
import { Link } from "react-router-dom";

const ContributeCardButton = ({type}) => {
  return (
    <div className="w-80 h-75 border border-neutral-300 rounded-xl p-6">
      <h1 className="font-semibold text-neutral-500">
        ...
        <span className="font-bold text-neutral-700">{ type === "photo" ? "photo" : "illustration" }</span>
      </h1>
      <Link to={"/submit-photo"} className="w-full h-[85%] mt-5 border-2 border-dashed border-neutral-300 rounded-xl flex items-center justify-center cursor-pointer hover:border-neutral-400 transition-all duration-200 ease-in-out group overflow-hidden relative">
        <img
          src={type === "photo" ? PhotoOne : IllustrationOne}
        ...
        />
        <img
          src={type === "photo" ? PhotoTwo : IllustrationTwo}
          alt="image_nature"
