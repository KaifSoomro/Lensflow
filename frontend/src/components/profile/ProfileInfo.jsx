  ...
  return (
    <div className="w-full h-70 p-10 flex items-start justify-center border-b border-neutral-300">
      <div className="flex items-start justify-center gap-15">
        <div>
          <img src={data?.profileImage || Image} alt="profile-img" className="w-40 rounded-full" />
        </div>
        <div>
          <div className="flex items-center gap-5">
            <h1 className="font-bold text-4xl text-neutral-900">{ data?.fullName }</h1>
            <Link
              to="/settings"
          ...
          <p className="mt-5">Download free, beautiful high-quality photos curated by { firstName }</p>
